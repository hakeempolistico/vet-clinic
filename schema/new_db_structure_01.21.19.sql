...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2019 at 07:15 PM
...
INSERT INTO `diagnose` (`diagnose_id`, `schedule_id`, `diagnose_details`, `treatment_details`, `note`) VALUES
(1, 1, 'Flees', NULL, NULL);
...
(1, 2, 'asd', 2, '2019-01-03', '08:30', '2019-01-03 08:30:00', 'asd', 1, 0),
(2, 1, 'asd', 2, '2019-01-03', '08:30', '2019-01-03 08:30:00', 'asd', 1, 0),
(3, 1, 'asd', 2, '2019-01-03', '08:30', '2019-01-03 08:30:00', 'asd', 1, 0),
(4, 1, 'asd', 2, '2019-01-03', '08:30', '2019-01-03 08:30:00', 'asd', 1, 0),
(5, 1, 'asd', 2, '2019-01-03', '08:30', '2019-01-03 08:30:00', 'asd', 1, 0),
(6, 1, 'asd', 2, '2019-01-03', '08:30', '2019-01-03 08:30:00', 'asd', 1, 0),
...
--
-- Indexes for table `global_parameter`
--
ALTER TABLE `global_parameter`
  ADD PRIMARY KEY (`global_parameter_id`);

--
-- Indexes for table `global_parameter_types`
--
ALTER TABLE `global_parameter_types`
  ADD PRIMARY KEY (`global_parameter_type_id`);
