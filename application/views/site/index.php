...
<html lang="zxx">
    ...
    <head>
        ...
        <!-- Custom-Files -->
        <link rel="stylesheet" href="<?= base_url('assets/site/css/bootstrap.css') ?>">
        <!-- Bootstrap-Core-CSS -->

        <!-- owl carousel -->
        <link rel="stylesheet" href="<?= base_url('assets/site/css/style.css') ?>" type="text/css" media="all" />
        <link href="<?= base_url('assets/site/css/blast.min.css') ?>" rel="stylesheet" />

        <!-- Style-CSS -->
        <!-- font-awesome-icons -->
        <link href="<?= base_url('assets/site/css/font-awesome.css') ?>" rel="stylesheet">
        <!-- //font-awesome-icons -->
        <!--lightbox -->
        <link rel="stylesheet" href="<?= base_url('assets/site/css/lightbox.css') ?>">
        <!-- lightbox -->
    ...
    <body>
                ...
                <div id="home" class="banner" data-blast="bgColor">
                    ...
                    <nav class="navbar navbar-expand-lg mb-4 top-bar navbar-static-top sps sps--abv">
                        <div class="container">
                            ...
                            <a class="navbar-brand mx-auto" href="index.html">Pet <span data-blast="color">Club</span></a>
        ...
        ================================================== -->
                    ...
                    <div class="swiper-container main-slider" id="myCarousel" data-blast="bgColor">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slider-bg-position" style="background:url(<?= base_url('assets/site/images/1.jpg') ?>)" data-hash="slide1">
                            ...
                            <div class="swiper-slide slider-bg-position" style="background:url(<?= base_url('assets/site/images/2.jpg') ?>)" data-hash="slide2">
                                <div class="ban-info" data-blast="bgColor">
                ...
                <div class="inner-sec-w3layouts py-md-5 py-3">
                    ...
                    <div class="row choose-main mb-lg-4">
                        <div class="col-lg-6 galsses-grid-right">
                            ...
                            <!---->
                            <h4 class="post mt-3">Lorem ipsum dolor sit amet, adipisicing elit sedc</h4>
                            <div class="line" data-blast="bgColor"></div>
                        ...
                        <div class="col-lg-6 galsses-grid-right">
                            <div class="galsses-grid-left">
                                <figure class="effect-lexi">
                                    <img src="<?= base_url('assets/site/images/4.jpg') ?>" alt="" class="img-fluid">
                                    <figcaption>
                                        <h3>Pet
                    ...
                    <div class="row choose-main my-lg-4 my-3">
                        <div class="col-lg-6 galsses-grid-right mt-lg-4">
                            <div class="galsses-grid-left">
                                <figure class="effect-lexi">
                                    <img src="<?= base_url('assets/site/images/5.jpg') ?>" alt="" class="img-fluid">
                                    <figcaption>
                                        <h3>Pet
                                            <span data-blast="color">Training</span>
                    ...
                    <div class="row choose-main mb-lg-4">
                        ...
                        <div class="col-lg-6 galsses-grid-right mt-lg-4">
                            <div class="galsses-grid-left">
                                <figure class="effect-lexi">
                                    <img src="<?= base_url('assets/site/images/6.jpg') ?>" alt="" class="img-fluid">
                                    <figcaption>
                                        <h3>Pet
                    ...
                    <div class="row choose-main mt-lg-4 mt-3">
                        <div class="col-lg-6 galsses-grid-right mt-lg-4">
                            <div class="galsses-grid-left">
                                <figure class="effect-lexi">
                                    <img src="<?= base_url('assets/site/images/7.jpg') ?>" alt="" class="img-fluid">
                                    <figcaption>
                                        <h3>Pet
                        ...
                        <div class="col-md-3 p-0 pr-2 col-sm-3 col-6 personal_gallery_grid1 hover14 column">
                            <div class="personal_gallery_effect">
                                <a href="images/g1.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
                                    <figure>
                                        <img src="<?= base_url('assets/site/images/g1.jpg') ?>" alt=" " class="img-fluid" />
                                    </figure>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-3 p-0 pr-2 col-sm-3 col-6 personal_gallery_grid1 hover14 column">
                            <div class="personal_gallery_effect">
                                <a href="images/g2.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
                                    <figure>
                                        <img src="<?= base_url('assets/site/images/g2.jpg') ?>" alt=" " class="img-fluid" />
                                    </figure>
                                </a>
                            </div>
                        ...
                        <div class="col-md-6 p-0 col-sm-6 col-12 pt-sm-0 pt-2 personal_gallery_grid1 hover14 column">
                            <div class="personal_gallery_effect">
                                <a href="images/g3.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
                                    <figure>
                                        <img src="<?= base_url('assets/site/images/g3.jpg') ?>" alt=" " class="img-fluid" />
                                    </figure>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 p-0 col-sm-6 col-12 pt-sm-0 pt-2 personal_gallery_grid1 view_gallery_grid1 hover14 column">
                            <div class="personal_gallery_effect">
                                <a href="images/g4.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
                                    <figure>
                                        <img src="<?= base_url('assets/site/images/g4.jpg') ?>" alt=" " class="img-fluid" />
                                    </figure>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-3 pt-2 pl-2 p-0 col-sm-3 col-6 personal_gallery_grid1 hover14 column">
                            <div class="personal_gallery_effect">
                                <a href="images/g5.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
                                    <figure>
                                        <img src="<?= base_url('assets/site/images/g5.jpg') ?>" alt=" " class="img-fluid" />
                                    </figure>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-3 pt-2 pl-2 p-0 col-sm-3 col-6 personal_gallery_grid1 hover14 column">
                            <div class="personal_gallery_effect">
                                <a href="images/g6.jpg" data-lightbox="example-set" data-title="Lorem Ipsum is simply dummy the when an unknown galley of type and scrambled it to make a type specimen.">
                                    <figure>
                                        <img src="<?= base_url('assets/site/images/g6.jpg') ?>" alt=" " class="img-fluid" />
                                    </figure>
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-md-3 reviews-box">
                                                <a href="#">
                                                    <img src="<?= base_url('assets/site/images/4.jpg') ?>" alt="Image" style="max-width:100%;">
                                                </a>
                                            ...
                                            <div class="col-md-3 reviews-box">
                                                <a href="#">
                                                    <img src="<?= base_url('assets/site/images/5.jpg') ?>" alt="Image" style="max-width:100%;">
                                                </a>
                                                <p class="my-4 text-left"><i class="fa fa-quote-right" aria-hidden="true"></i> Lorem ipsum dolor sit amet Neque porro quisquam est qui doloreman unknown printer took a galley of type..</p>
                                            </div>
                                            <div class="col-md-3 reviews-box">
                                                <a href="#">
                                                    <img src="<?= base_url('assets/site/images/7.jpg') ?>" alt="Image" style="max-width:100%;">
                                                </a>
                                                <p class="my-4 text-left"><i class="fa fa-quote-right" aria-hidden="true"></i> Lorem ipsum dolor sit amet Neque porro quisquam est qui doloreman unknown printer took a galley of type..</p>
                                            </div>
                                            <div class="col-md-3 reviews-box">
                                                <a href="#">
                                                    <img src="<?= base_url('assets/site/images/8.jpg') ?>" alt="Image" style="max-width:100%;">
                                                </a>
                                                <p class="my-4 text-left"><i class="fa fa-quote-right" aria-hidden="true"></i> Lorem ipsum dolor sit amet Neque porro quisquam est qui doloreman unknown printer took a galley of type..</p>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-4 footer-grid">
                        ...
                        <div class="blog-grids row mb-3">
                            <div class="col-md-4 blog-grid-left">
                                <a href="single.html">
                                    <img src="<?= base_url('assets/site/images/5.jpg') ?>" class="img-fluid" alt="">
                                </a>
                            </div>
                        ...
                        <div class="blog-grids row mb-3">
                            <div class="col-md-4 blog-grid-left">
                                <a href="single.html">
                                    <img src="<?= base_url('assets/site/images/4.jpg') ?>" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="col-md-8 blog-grid-right">
                                <h5>
                        ...
                        <div class="blog-grids row mb-3">
                            <div class="col-md-4 blog-grid-left">
                                <a href="single.html">
                                    <img src="<?= base_url('assets/site/images/6.jpg') ?>" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="col-md-8 blog-grid-right">
                                <h5>
        ...
        <!--//banner-->
        <!--//footer-->
        <script src="<?= base_url('assets/site/js/jquery-2.2.3.min.js') ?>"></script>
        <script src="<?= base_url('assets/site/js/boost.js') ?>"></script>
        <script src="<?= base_url('assets/site/js/blast.min.js') ?>"></script>
        <!--  light box js -->
        <script src="<?= base_url('assets/site/js/lightbox-plus-jquery.min.js') ?>">
        </script>
        <script>
            // optional
        ...
        <script src="<?= base_url('assets/site/js/move-top.js') ?>"></script>
        <script src="<?= base_url('assets/site/js/easing.js') ?>"></script>
        <script>
        ...
        <script src="<?= base_url('assets/site/js/bootstrap.js') ?>"></script>
